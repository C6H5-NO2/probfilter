 ...
 */
object UnsignedVal {
  implicit class RichUnsignedByte(private val b: Byte) extends AnyVal {
  ...
  implicit class RichUnsignedShort(private val s: Short) extends AnyVal {
  ...
  implicit class RichUnsignedInt(private val i: Int) extends AnyVal {
