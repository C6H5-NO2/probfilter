...
@SerialVersionUID(1L)
final class MapCuckooTable[@specialized(Byte, Short, Long) E: ClassTag](private val data: HashMap[Int, Array[E]], val size: Int)
...
object MapCuckooTable {
  ...
  private final class MapCuckooBucket[@specialized(Byte, Short, Long) E: ClassTag]
  (private val table: MapCuckooTable[E], val at: Int) extends CuckooBucket[E] {
